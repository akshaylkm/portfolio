...
function Projects() {
  return <div className=' h-screen pl-9'>
      <h1 className='font-medium text-xl sm:text-4xl'>SOME OF MY WORKS AND PERSONAL PROJECTS</h1>
      <div className=' p-5 sm:flex justify-center items-center pt-24'>
      ...
      <div className=' pl-4 pt-10 sm:pt-32'>
